...
class CharliePuthWindow < Gosu::Window
  PURPLE = Gosu::Color.new(0xff_800080)  # Define a custom purple color

  def initialize
    super 850, 650
    self.caption = "Charlie Puth Album"

    @background_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Charlie_Puth_Background.jpeg", tileable: true)
    @back_button_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Back_button.png")
    @back_button_scale = 0.2
    @album_cover = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Charlie_Puth.jpg")
    ...
    @songs = ["ATTENTION", "WE DON'T TALK ANYMORE", "SEE YOU AGAIN", "LEFT AND RIGHT", "ONE CALL AWAY", "HOW LONG"]
    @current_song = nil
