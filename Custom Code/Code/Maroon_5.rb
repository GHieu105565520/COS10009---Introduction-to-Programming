...
class Maroon5Window < Gosu::Window
  PURPLE = Gosu::Color.new(0xff_800080)  # Define a custom purple color

  def initialize
    super 850, 650
    self.caption = "Maroon 5 Album"

    @background_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Maroon_5_Background.jpeg", tileable: true)
    @back_button_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Back_button.png")
    @back_button_scale = 0.2
    @album_cover = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Maroon_5.jpg")
    ...
    @songs = ["SUGAR", "GIRLS LIKE YOU", "DON'T WANNA KNOW", "MAPS", "PAYPHONE", "ANIMALS"]
    @current_song = nil
