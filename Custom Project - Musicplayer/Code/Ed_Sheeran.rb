...
class EdSheeranWindow < Gosu::Window
  PURPLE = Gosu::Color.new(0xff_800080)  # Define a custom purple color

  def initialize
    super 850, 650
    self.caption = "Ed Sheeran Album"

    @background_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Ed_Sheeran_background.jpeg", tileable: true)
    @back_button_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Back_button.png")
    @back_button_scale = 0.2
    @album_cover = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Ed_Sheeran.jpg")
    ...
    @songs = ["SHAPE OF YOU", "PERFECT", "SHIVERS", "PHOTOGRAPH", "HAPPIER", "BAD HABITS"]
    @current_song = nil
