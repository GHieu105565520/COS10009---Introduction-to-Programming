...
class HIEUTHUHAIWindow < Gosu::Window
  PURPLE = Gosu::Color.new(0xff_800080)  # Define a custom purple color

  def initialize
    super 850, 650
    self.caption = "HIEUTHUHAI Album"

    @background_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/HIEUTHUHAI_Background.jpg", tileable: true)
    @back_button_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Back_button.png")
    @back_button_scale = 0.2
    @album_cover = Gosu::Image.new("D:/Programming/Ruby_coding/Images/HIEUTHUHAI.jpg")
    ...
    @songs = ["NGỦ MỘT MÌNH", "NGHE NHƯ TÌNH YÊU", "BẬT NHẠC LÊN", "ĐEN ĐÁ KHÔNG ĐƯỜNG", "WALK", "QUAY ĐI QUAY LẠI", "KIM PHÚT KIM GIỜ", "LOVE SAND"]
    @current_song = nil
  ...
  def draw_album_cover_and_songs
    ...
    # Draw album cover
    x_album = (width / 4) - (@album_cover.width * @album_scale) / 2 - 90  # Move a bit more to the left
  ...
  def draw_track_box
    ...
    x_track_box = (3 * width / 4) - (@track_box_image.width * @track_box_scale) / 2 + 40  # Move to the right
