...
class AlanWalkerWindow < Gosu::Window
  PURPLE = Gosu::Color.new(0xff_800080)  # Define a custom purple color

  def initialize
    super 850, 650
    self.caption = "Alan Walker Album"

    @background_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Alan_Walker_background.jpeg", tileable: true)
    @back_button_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Back_button.png")
    @back_button_scale = 0.2
    @album_cover = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Alan_Walker.jpg")
    ...
    @track_box_scale = 0.5  # Smaller scale for the track box

    @songs = ["FADED", "ALONE", "THE SPECTRE", "SING ME TO SLEEP", "DARK SIDE", "SKY"]
    @current_song = nil
