...
class ImagineDragonWindow < Gosu::Window
  ...
  def initialize
    ...
    @background_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Imagine_Dragon_Background.jpeg", tileable: true)
    @back_button_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Back_button.png")
    @back_button_scale = 0.2
    @album_cover = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Imagine_Dragon.jpg")
