...
class DENVAUWindow < Gosu::Window
  PURPLE = Gosu::Color.new(0xff_800080)  # Define a custom purple color

  def initialize
    super 850, 650
    self.caption = "Đen Vâu Album"

    @background_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/ĐEN_VAU_Background.jpg", tileable: true)
    @back_button_image = Gosu::Image.new("D:/Programming/Ruby_coding/Images/Back_button.png")
    @back_button_scale = 0.2
    @album_cover = Gosu::Image.new("D:/Programming/Ruby_coding/Images/ĐEN_VÂU.jpg")
    ...
    @songs = ["ĐI VỀ NHÀ", "MANG TIỀN VỀ CHO MẸ", "NẤU ĂN CHO EM", "LUÔN YÊU ĐỜI", "TRỐN TÌM", "AI MUỐN NGHE KHÔNG"]
    @current_song = nil
